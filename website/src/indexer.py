...
class InvertedIndex:
    ...
    def __init__(self):
        ...
        self.index_file = "D:\Yoga Punya\Belajar Web\\testfile_web\website\src\inverted_index.json"
...
class PositionalInvertedIndex(InvertedIndex):
    ...
    def __init__(self):
        super().__init__()
        self.index_file = "D:\Yoga Punya\Belajar Web\\testfile_web\website\src\positional_index.json"
